    ...
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
      ...
      <div style="padding: 30px; color: #333333;">
        ...
        <div style="text-align: center; margin-top: 20px;">
          <a href="https://notoria.app/login" style="display: inline-block; padding: 12px 24px; background-color: #4f46e5; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold;">
